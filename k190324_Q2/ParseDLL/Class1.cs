...
namespace ParseDLL
{
    public static class HtmlFileManipulation
    {
        public static void CreateDirectories(HtmlAgilityPack.HtmlNodeCollection tables, ArrayList categoriesList, string path)
        {
        ...
        public static void ManipulateContent(string path)
        {
            ...
            if (doc.DocumentNode != null)
            {
                ...
                CreateDirectories(tables, categoriesList, path);
        ...
        static public void ParseData()
        {
            var appSettings = ConfigurationManager.AppSettings;
            string path = appSettings["path"];

            ManipulateContent(path);
        }
    }
}